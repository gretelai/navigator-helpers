    ...
    if df is not None:
        ...
        with st.expander("Advanced Options", expanded=False):
            ...
            use_aaa = st.checkbox(
                ...
                help="Enable or disable the use of AI Align AI. Note: AAA improves output quality by iteratively improving output with multiple LLMs, but reduces synthetic data generation speed.",
            )
        ...
        with st.expander("Model Configuration", expanded=True):
            ...
            st.write(
                "Select additional language models for co-teaching. It is recommended to use different LLMs than the primary Navigator LLM for this step."
            )
        ...
        with st.expander("Download Configuration", expanded=False):
            config_text = f"""
        ...
        """
            ...
            st.download_button(
                label="Download DataAugmentationConfig",
                data=config_text,
                file_name="data_augmentation_config.txt",
                mime="text/plain",
            )
